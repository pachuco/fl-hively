package replay_hively {
    internal class hvl_tune{
        internal var ht_Name:String;                              //TEXT[128]
        internal var ht_SongNum:uint;                             //uint16
        internal var ht_Frequency:uint;                           //uint32
        internal var ht_FreqF:Number;                             //float64
        internal var ht_WaveformTab:Vector.<uint>;                //*int8[MAX_CHANNELS]
        internal var ht_WaveformTab_i2:Vector.<int>;
        internal var ht_Restart:uint;                             //uint16
        internal var ht_PositionNr:uint;                          //uint16
        internal var ht_SpeedMultiplier:uint;                     //uint8
        internal var ht_TrackLength:uint;                         //uint8
        internal var ht_TrackNr:uint;                             //uint8
        internal var ht_InstrumentNr:uint;                        //uint8
        internal var ht_SubsongNr:uint;                           //uint8
        internal var ht_PosJump:uint;                             //uint16
        internal var ht_PlayingTime:uint;                         //uint32
        internal var ht_Tempo:int;                                //int16
        internal var ht_PosNr:int;                                //int16
        internal var ht_StepWaitFrames:int;                       //int16
        internal var ht_NoteNr:int;                               //int16
        internal var ht_PosJumpNote:uint;                         //uint16
        internal var ht_GetNewPosition:uint;                      //uint8
        internal var ht_PatternBreak:uint;                        //uint8
        internal var ht_SongEndReached:uint;                      //uint8
        internal var ht_Stereo:uint;                              //uint8
        internal var ht_Subsongs:Vector.<uint>;                   //*uint16
        internal var ht_Channels:uint;                            //uint16
        internal var ht_Positions:Vector.<hvl_position>;          //struct hvl_position *ht_Positions;
        internal var ht_Tracks:Vector.<Vector.<hvl_step>>;        //hvl_step[256][64]
        internal var ht_Instruments:Vector.<hvl_instrument>;      //struct hvl_instrument *ht_Instruments;
        internal var ht_Voices:Vector.<hvl_voice>;                //hvl_voice[MAX_CHANNELS]
        internal var ht_defstereo:int;                            //int32
        internal var ht_defpanleft:int;                           //int32
        internal var ht_defpanright:int;                          //int32
        internal var ht_mixgain:int;                              //int32
        internal var ht_Version:uint;                             //uint8
        ...
        internal function hvl_reset_some_stuff():void{
            var i:uint;
